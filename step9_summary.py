...
台帳549件＋未照会のリーダーボード層1500件を精査し、分散テスト通過18件 → <b>うちmajors実現益が黒字の6件</b>を🟠弱い疑惑(監視継続)へ。
<table style="max-width:520px;margin-top:6px"><tr><th>アドレス</th><th>補正72h</th><th>majors実現益</th></tr>
<tr><td>0xccf135ab…</td><td>+9.3%</td><td><b class="g">+$1.31M</b></td></tr>
<tr><td>0x3662dd1d… (Smart HL Perps Trader)</td><td>+6.5%</td><td>+$952k</td></tr>
<tr><td>0xda0950da…</td><td>+3.4%</td><td>+$587k</td></tr>
<tr><td>0xef91b28f… (Smart HL Perps Trader)</td><td>+4.0%</td><td>+$278k</td></tr>
<tr><td>0x885989fd…</td><td>+3.6%</td><td>+$263k</td></tr>
<tr><td>0x8ff1d5d5… (Former Smart Trader)</td><td>+3.1%</td><td>+$228k</td></tr></table>
<b>第二の教訓:</b> 遅効エッジ指標は単独では<b class="r">負け組も拾う</b>（「建玉後72hに順方向へ動いた」≠「儲けた」）。実際、分散通過18件中12件はmajors赤字で偽陽性だった。＝<u>挙動シグナルは必ず実現損益と組み合わせる</u>。<br>
ただしこの6件も「実力スイングトレーダー」と「遅効カタリストへの先行positioning」は挙動だけでは断定不可。資金源はCEX直/橋が混在で隠蔽の確証なし＝<b>最有力の監視対象だが断定はしない</b>。
</div>
<div class="box warn">
