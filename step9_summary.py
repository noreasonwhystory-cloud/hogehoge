...
<a href="index.html">← トップ</a> ／ <a href="registry.html">インサイダー</a> ／ <a href="deception.html">欺瞞検知</a> ／ <a href="compare.html">HL vs Nansen</a></div>
...
いずれも人間レビュー用で、リアルタイムの建玉は<a href="live.html">ライブ監視</a>で追う。</div>
...
約定履歴は中央値106日・最大2.5年遡れており、結論は数ヶ月〜年単位の履歴の上で出している。
<br><b>網羅性(監査で是正):</b> 当初はcache 3,844件中の発掘・照会済みのみを台帳化していたが、整合性監査で<b>majors実現≥$50万の未トリアージ高額層86件(本物プロ7・高頻度MM79)</b>を追加分類し台帳に取り込んだ。majors実現&lt;$50万・alt主体の層は majors先物スコープ外として意図的に未台帳のまま残す。</div>
</body></html>"""
