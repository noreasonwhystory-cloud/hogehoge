...
<div class="box no" style="margin-top:12px">
<b class="big">「往復という定義が厳しすぎただけでは？」を検証 → 4つの独立した物差しが同じ結論に収束。</b><br>
往復(利確を要求)では保有型インサイダーを取りこぼす懸念があるため、<b>往復に依存しない3定義</b>を追加で全プール(プロ＋出金疑い＋旧疑惑 計105件)に当てた:
...
上位20候補を再度workflow(21エージェント)で個別精査しても<b class="r">昇格ゼロ・全件現状維持</b>。＝<b>往復定義の欠陥ではなく、4定義すべてで個人インサイダーは検出されない</b>。浮上した候補は全員、下落/上昇regime便乗＋モメンタム順張り＋少数の神トレードのサバイバーシップ＋MM高回転で過不足なく説明できた。
</div>
<div class="box warn">
